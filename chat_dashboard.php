...
function chat_Dashboard()
{
    ...
    <div class="container">
        ...
        <div class="messaging">
                ...
                <div class="mesgs">
                    ...
                    <div class="type_msg">
                        <div class="input_msg_write">
                            ...
                            <input type="text" class="write_msg" placeholder="Type a message" id="usermsg"/>
            ...
            <p class="text-center top_spac"> Design by <a target="_blank" href="#">Sahil Gulati</a></p>
